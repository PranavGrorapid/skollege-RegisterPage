          ...
          <div className="py-10">
            <div className="">
                ...
                <div className=" xl:flex xl:flex-row xl:items-center  xl:justify-center  xl:space-x-5 ">
                  <div className="xl:flex xl:flex-col xl:space-y-4">
                    ...
                    <div className="w-[425px] h-[258px] bg-stone-50 rounded-[10px] p-4">
                      <div className="w-[380px] text-neutral-900 text-sm font-medium tracking-widest py-1">
                        Zero-cost expert counsel wth a wide industry experience
                    ...
                    <div className="w-[425px] h-[218px] bg-stone-50 rounded-[10px] p-5">
                      ...
                      <div className="py-1">
                        <img
                          className="w-[344px] h-[107px]"
                          src="./images/registerpage/scholoarshipAd.png"
                        />
                      </div>
                    </div>
                  ...
                  <div className="xl:flex xl:flex-col-reverse  xl:text-center ">
                      ...
                      <div className="py-1">
                        <div className="flex items-center justify-center my-3 space-x-3">
                          <div>
                            <img
                              className=""
                              src="./images/registerpage/amityyyadd.png"
                            />
                          </div>
                          <div>
                            <img
                    ...
                    <div className="w-[425px] h-[218px] bg-stone-50 rounded-[10px] p-5  xl:h-[250px] xl:mt-20">
                      <div className="text-neutral-900 text-xl font-medium tracking-widest">
                        Only approved universities
                      </div>
                      ...
                      <div className="py-5 md:block xl:hidden">
                        <div className="flex items-center justify-between my-3">
                          <div>
                            <img
                              className=""
                              src="./images/registerpage/aicte.png"
                            />
                          </div>
                          ...
                          <div>
                            <img
                              className=""
                              src="./images/registerpage/image 13.png"
                            />
                          </div>
                          ...
                          <div>
                            <img
                              className=""
                              src="./images/registerpage/image 15.png"
                            />
                          </div>
                          ...
                          <div>
                            <img
                              className=""
                              src="./images/registerpage/image16.png"
                            />
                          </div>
                        </div>
                      </div>
              ...
              <div className=" hidden  md:block p-4">
                <span className="text-zinc-600 text-xl font-medium leading-loose">
                  Not a member yet?{" "}
                </span>
                <span className="text-orange-400 text-xl font-medium leading-loose">
                  Join us
                </span>
                <span className="text-zinc-600 text-xl font-medium leading-loose">
                  {" "}
